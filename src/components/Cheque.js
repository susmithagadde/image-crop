...
class Cheque extends Component {
    ...
    onSave = (e) => {
        ...
        let requestOptions = {
            method: 'POST',
              headers: { "Access-Control-Allow-Origin": "https://e02h44i2oe.execute-api.ap-south-1.amazonaws.com/test"},
              body: JSON.stringify({ image64: strImage })   
        }
                
        

        fetch('https://cors-anywhere.herokuapp.com/https://e02h44i2oe.execute-api.ap-south-1.amazonaws.com/test', requestOptions)
        .then(res => res.json())
        .then(response => {
                ...
                <div className="cards-list">
                    <div className="card 1">
                        <div className="card_title title-white">
                                <p>Account: <span>{extractedData.account}</span></p>
                                <p>IFSC: <span>{extractedData.ifsc}</span></p>
